...
for (fold in seq(1, 10)) {
  ...
  rmse_sincefeb2022 <- append(rmse_sincefeb2022, RMSE(pred_10cv_sincefeb2022, obs_10cv_sincefeb2022))
  btrmse_sincefeb2022 <- append(btrmse_sincefeb2022, RMSE(exp(pred_10cv_sincefeb2022), obs_10cv_sincefeb2022))
}
...
for (fold in seq(1, 10)) {
  ...
  rmse_disaster <- append(rmse_disaster, RMSE(pred_10cv_disaster, obs_10cv_disaster))
  btrmse_disaster <- append(btrmse_disaster, RMSE(exp(pred_10cv_disaster), obs_10cv_disaster))
}
...
for (fold in seq(1, 10)) {
  ...
  rmse_excl_dis <- append(rmse_excl_dis, RMSE(pred_10cv_excl_dis, obs_10cv_excl_dis))
  btrmse_excl_dis <- append(btrmse_excl_dis, RMSE(exp(pred_10cv_excl_dis), obs_10cv_excl_dis))
}
...
for (fold in seq(1, 10)) {
  ...
  rmse_disaster_ind <- append(rmse_disaster_ind, RMSE(pred_10cv_disaster_ind, obs_10cv_disaster_ind))
  btrmse_disaster_ind <- append(btrmse_disaster_ind, RMSE(exp(pred_10cv_disaster_ind), obs_10cv_disaster_ind))
}
...
for (fold in seq(1, 10)) {
  ...
  rmse_everything <- append(rmse_everything, RMSE(pred_10cv_everything, obs_10cv_everything))
  btrmse_everything <- append(btrmse_everything, RMSE(exp(pred_10cv_everything), obs_10cv_everything))
}
