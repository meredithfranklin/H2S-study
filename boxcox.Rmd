...
for (fold in seq(1, 10)) {
  ...
  bt_adj_r2_sincefeb2022 <- c(bt_adj_r2_sincefeb2022, 
  ...
  bt_adj_r2_test_sincefeb2022 <- c(bt_adj_r2_test_sincefeb2022, bt_adj_r2_test)
...
for (fold in seq(1, 10)) {
  ...
  bt_adj_r2_disaster <- c(bt_adj_r2_disaster, 
                              adj_r2(R2(exp(predict(h2s_da_model_10cv, newdata = train)), train$H2S_daily_avg),
                              summary(h2s_da_model_10cv)$n, summary(h2s_da_model_10cv)$np))
  adj_r2_test_disaster <- append(adj_r2_test_disaster, adj_r2_test)
  bt_adj_r2_test_disaster <- c(bt_adj_r2_test_disaster, bt_adj_r2_test)
...
for (fold in seq(1, 10)) {
  ...
  bt_adj_r2_excl_dis <- c(bt_adj_r2_excl_dis, 
                              adj_r2(R2(exp(predict(h2s_da_model_10cv, newdata = train)), train$H2S_daily_avg),
                              summary(h2s_da_model_10cv)$n, summary(h2s_da_model_10cv)$np))
...
for (fold in seq(1, 10)) {
  ...
  bt_adj_r2_disaster_ind <- c(bt_adj_r2_disaster_ind, 
                              adj_r2(R2(exp(predict(h2s_da_model_10cv, newdata = train)), train$H2S_daily_avg),
                              summary(h2s_da_model_10cv)$n, summary(h2s_da_model_10cv)$np))
  adj_r2_test_disaster_ind <- append(adj_r2_test_disaster_ind, adj_r2_test)
  bt_adj_r2_test_disaster_ind <- c(bt_adj_r2_test_disaster_ind, bt_adj_r2_test)
  rmse_disaster_ind <- append(rmse_disaster_ind, RMSE(predictions, log(log(test$H2S_daily_avg))))
...
for (fold in seq(1, 10)) {
  ...
  bt_adj_r2_everything <- c(bt_adj_r2_everything, 
                              adj_r2(R2(exp(predict(h2s_da_model_10cv, newdata = train)), train$H2S_daily_avg),
                              summary(h2s_da_model_10cv)$n, summary(h2s_da_model_10cv)$np))
  adj_r2_test_everything <- append(adj_r2_test_everything, adj_r2_test)
  bt_adj_r2_test_everything <- c(bt_adj_r2_test_everything, bt_adj_r2_test)
