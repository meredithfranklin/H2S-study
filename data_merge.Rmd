...
#   monitor_well_api <- drop_units(st_distance(monitors[i, ], well_location))
#   monitor_well_api <- well_location[which(monitor_well_api <= 1000), ] %>% st_drop_geometry()
#   monitor_wells <- append(monitor_wells, list(monitor_well_api))
# }
# 
# monitor_well <- st_distance(monitors, well_location)
