...
writeLines(sincefeb2022_model_stat_latex, '../figures/da_sincefeb2022_log_model.tex')
...
```{r}
dis_model_stat <- get_gam_result(log_da_dis_gam, 'Daily Average H2S Event') 

event_model_stat_latex <- knitr::kable(dis_model_stat, format = 'latex', digits = 2)
writeLines(event_model_stat_latex, '../figures/da_event_log_model.tex')

knitr::kable(dis_model_stat, format = 'html', digits = 2)
```
