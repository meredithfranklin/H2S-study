...
result_10cv <- tibble(Model = character(),
                 'Train R-Sq' = numeric(),
                 'BT Train R-Sq' = numeric(),
                 'Test R-Sq' = numeric(),
                 'BT Test R-Sq' = numeric(),
                 'Test RMSE' = numeric(),
...
bt_adj_r2_sincefeb2022 <- c()
bt_adj_r2_test_sincefeb2022 <- c()
rmse_sincefeb2022 <- c()
...
for (fold in seq(1, 10)) {
  ...
  r2_test <- R2(log(test$H2S_daily_avg), predictions)
  bt_r2_test <- R2(test$H2S_daily_avg, exp(predictions))
  adj_r2_test <- adj_r2(r2_test, summary(h2s_da_model_10cv)$n, summary(h2s_da_model_10cv)$np)
  bt_adj_r2_test <- adj_r2(bt_r2_test, summary(h2s_da_model_10cv)$n, summary(h2s_da_model_10cv)$np)
  ...
  bt_adj_r2_sincefeb2022 <- append(bt_adj_r2_sincefeb2022, 
                              adj_r2(R2(exp(predict(h2s_da_model_10cv, newdata = train)), train$H2S_daily_avg),
                              summary(h2s_da_model_10cv)$n, summary(h2s_da_model_10cv)$np))
  adj_r2_test_sincefeb2022 <- append(adj_r2_test_sincefeb2022, adj_r2_test)
  bt_adj_r2_test_sincefeb2022 <- append(bt_adj_r2_test_sincefeb2022, bt_adj_r2_test)
  rmse_sincefeb2022 <- append(rmse_sincefeb2022, RMSE(predictions, log(test$H2S_daily_avg)))
...
result_10cv <- rbind(result_10cv, tibble(Model = 'Since Feb 2022 Log Transform',
                                         'Train R-Sq' = mean(adj_r2_sincefeb2022),
                                         'BT Train R-Sq' = mean(bt_adj_r2_sincefeb2022),
                                         'Test R-Sq' = mean(adj_r2_test_sincefeb2022),
                                         'BT Test R-Sq' = mean(bt_adj_r2_test_sincefeb2022),
...
logh2s_10cv_ovp_plot_sincefeb2022 <- ggplot(tibble(obs = obs_10cv_sincefeb2022, pred = exp(pred_10cv_sincefeb2022)),
                        ...
                        geom_point() +
                        stat_poly_line() +
                        stat_poly_eq(use_label(c("eq")), label.x = "right", label.y = 0.45) +
                        stat_poly_eq(use_label(c("R2")), label.x = "right", label.y = 0.56) +
                        stat_poly_eq(use_label(c("n")), label.x = "right", label.y = 0.60) +
                        labs(y = 'Observed', x = 'Predicted', 
...
bt_adj_r2_disaster <- c()
bt_adj_r2_test_disaster <- c()
rmse_disaster <- c()
btrmse_disaster <- c()
...
for (fold in seq(1, 10)) {
  ...
  bt_adj_r2_disaster <- append(bt_adj_r2_disaster, 
                              adj_r2(R2(exp(predict(h2s_da_model_10cv, newdata = train)), train$H2S_daily_avg),
                              summary(h2s_da_model_10cv)$n, summary(h2s_da_model_10cv)$np))
  adj_r2_test_disaster <- append(adj_r2_test_disaster, adj_r2_test)
  bt_adj_r2_test_disaster <- append(bt_adj_r2_test_disaster, bt_adj_r2_test)
  rmse_disaster <- append(rmse_disaster, RMSE(predictions, log(test$H2S_daily_avg)))
...
result_10cv <- rbind(result_10cv, tibble(Model = 'Disaster Only Log Transform',
                               'Train R-Sq' = mean(adj_r2_disaster),
                                         'BT Train R-Sq' = mean(bt_adj_r2_disaster),
                                         'Test R-Sq' = mean(adj_r2_test_disaster),
                                         'BT Test R-Sq' = mean(bt_adj_r2_test_disaster),
...
bt_adj_r2_excl_dis <- c()
bt_adj_r2_test_excl_dis <- c()
rmse_excl_dis <- c()
btrmse_excl_dis <- c()
...
for (fold in seq(1, 10)) {
  ...
  bt_adj_r2_excl_dis <- append(bt_adj_r2_excl_dis, 
                              adj_r2(R2(exp(predict(h2s_da_model_10cv, newdata = train)), train$H2S_daily_avg),
                              summary(h2s_da_model_10cv)$n, summary(h2s_da_model_10cv)$np))
  adj_r2_test_excl_dis <- append(adj_r2_test_excl_dis, adj_r2_test)
  bt_adj_r2_test_excl_dis <- c(bt_adj_r2_test_excl_dis, bt_adj_r2_test)
  rmse_excl_dis <- append(rmse_excl_dis, RMSE(predictions, log(test$H2S_daily_avg)))
...
result_10cv <- rbind(result_10cv, tibble(Model = 'Exclude Disaster Log Transform',
                                         'Train R-Sq' = mean(adj_r2_excl_dis),
                                         'BT Train R-Sq' = mean(bt_adj_r2_excl_dis),
                                         'Test R-Sq' = mean(adj_r2_test_excl_dis),
                                         'BT Test R-Sq' = mean(bt_adj_r2_test_excl_dis),
...
bt_adj_r2_disaster_ind <- c()
bt_adj_r2_test_disaster_ind <- c()
rmse_disaster_ind <- c()
...
for (fold in seq(1, 10)) {
  ...
  predictions <- predict(h2s_da_model_10cv, newdata = test) 
  r2_test <- R2(log(test$H2S_daily_avg), predictions)
  bt_r2_test <- R2(log(test$H2S_daily_avg), exp(predictions))
  adj_r2_test <- adj_r2(r2_test, summary(h2s_da_model_10cv)$n, summary(h2s_da_model_10cv)$np)
  bt_adj_r2_test <- adj_r2(bt_r2_test, summary(h2s_da_model_10cv)$n, summary(h2s_da_model_10cv)$np)
  ...
  bt_adj_r2_disaster_ind <- append(bt_adj_r2_disaster_ind, 
                              adj_r2(R2(exp(predict(h2s_da_model_10cv, newdata = train)), train$H2S_daily_avg),
                              summary(h2s_da_model_10cv)$n, summary(h2s_da_model_10cv)$np))
  adj_r2_test_disaster_ind <- append(adj_r2_test_disaster_ind, adj_r2_test)
  bt_adj_r2_test_disaster_ind <- append(bt_adj_r2_test_disaster_ind, bt_adj_r2_test)
  rmse_disaster_ind <- append(rmse_disaster_ind, RMSE(predictions, log(test$H2S_daily_avg)))
...
result_10cv <- rbind(result_10cv, tibble(Model = 'Everything w. Disaster Indicator Log Transform',
                               'Train R-Sq' = mean(adj_r2_disaster_ind),
                                         'BT Train R-Sq' = mean(bt_adj_r2_disaster_ind),
                                         'Test R-Sq' = mean(adj_r2_test_disaster_ind),
                                         'BT Test R-Sq' = mean(bt_adj_r2_test_disaster_ind),
...
bt_adj_r2_everything <- c()
bt_adj_r2_test_everything <- c()
rmse_everything <- c()
btrmse_everything <- c()
...
for (fold in seq(1, 10)) {
  ...
  bt_adj_r2_everything <- append(bt_adj_r2_everything, 
                              adj_r2(R2(exp(predict(h2s_da_model_10cv, newdata = train)), train$H2S_daily_avg),
                              summary(h2s_da_model_10cv)$n, summary(h2s_da_model_10cv)$np))
  adj_r2_test_everything <- append(adj_r2_test_everything, adj_r2_test)
  bt_adj_r2_test_everything <- append(bt_adj_r2_test_everything, bt_adj_r2_test)
  rmse_everything <- append(rmse_everything, RMSE(predictions, log(test$H2S_daily_avg)))
...
result_10cv <- rbind(result_10cv, tibble(Model = 'Everything w.o Disaster Indicator Log Transform',
                               'Train R-Sq' = mean(adj_r2_everything),
                                         'BT Train R-Sq' = mean(bt_adj_r2_everything),
                                         'Test R-Sq' = mean(adj_r2_test_everything),
                                         'BT Test R-Sq' = mean(bt_adj_r2_test_everything),
...
```{r}
fit.xgb_da_log_h2s_dis_ind_8020 <- readRDS('rfiles/fit.xgb_da_log_h2s_dis_ind_8020.rds')
```

```{r}
getTrainPerf(fit.xgb_da_log_h2s_dis_ind_8020)
```

```{r}
fit.xgb_da_log_h2s_dis_ind_8020$finalModel
```
...
# Here, we compute the R2 and RMSE for each fold and take the average
fold_stat <- fit.xgb_da_log_h2s_dis_ind_8020$pred %>% group_by(Resample) %>% 
  summarise(R2 = R2(pred, obs), RMSE = RMSE(pred, obs),
            R2_BT = R2(exp(pred), exp(obs)), RMSE_BT = RMSE(exp(pred), exp(obs)))
test_r2 <- mean(fold_stat$R2)
test_r2_bt <- mean(fold_stat$R2_BT)
...
```{r}
test_pred <- predict(fit.xgb_da_log_h2s_dis_ind_8020, newdata = test)
test_20_r2 <- R2(test_pred, test$H2S_daily_avg)
test_20_r2_bt <- R2(exp(test_pred), exp(test$H2S_daily_avg))
test_20_rmse <- RMSE(test_pred, test$H2S_daily_avg)
test_20_rmse_bt <- RMSE(exp(test_pred), exp(test$H2S_daily_avg))
```

```{r}
result_8020 <- tibble(Model = 'Everything w. Disaster Indicator Log Transform',
                      'OOB R2' = test_r2,
                      'OOB BT R2' = test_r2_bt,
                      'OOB RMSE' = test_rmse,
                      'OOB BT RMSE' = test_rmse_bt,
                      '20% Test R2' = test_20_r2,
                      '20% Test BT R2' = test_20_r2_bt,
                      '20% Test RMSE' = test_20_rmse,
                      '20% Test BT RMSE' = test_20_rmse_bt)
```
...
### 80/20 Split
```{r}
fit.xgb_da_log_h2s_full_8020 <- readRDS('rfiles/fit.xgb_da_log_h2s_full_8020.rds')
```

```{r}
getTrainPerf(fit.xgb_da_log_h2s_full_8020)
```

```{r}
fit.xgb_da_log_h2s_full_8020$finalModel
```
...
# Out-of-bag statistics
# Here, we compute the R2 and RMSE for each fold and take the average
fold_stat <- fit.xgb_da_log_h2s_full_8020$pred %>% group_by(Resample) %>% 
  summarise(R2 = R2(pred, obs), RMSE = RMSE(pred, obs),
            R2_BT = R2(exp(pred), exp(obs)), RMSE_BT = RMSE(exp(pred), exp(obs)))
test_r2 <- mean(fold_stat$R2)
test_r2_bt <- mean(fold_stat$R2_BT)
...
```{r}
test_pred <- predict(fit.xgb_da_log_h2s_full_8020, newdata = test)
test_20_r2 <- R2(test_pred, test$H2S_daily_avg)
test_20_r2_bt <- R2(exp(test_pred), exp(test$H2S_daily_avg))
test_20_rmse <- RMSE(test_pred, test$H2S_daily_avg)
test_20_rmse_bt <- RMSE(exp(test_pred), exp(test$H2S_daily_avg))
...
```{r}
# 80/20 split results
log_8020_model_perf_table <- tibble(Model = c('Everything w. Disaster Indicator Log Transform',
                                              'Everything w.o Disaster Indicator Log Transform')) %>% 
  left_join(rbind(xgb_result)) %>%
  left_join(result_8020)
knitr::kable(log_8020_model_perf_table, digits = 2)
```
