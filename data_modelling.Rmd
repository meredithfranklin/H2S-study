...
sincefeb2022_model_stat <- get_gam_result(h2s_da_model_f, 'Daily Average H2S Since Feb 2022') 

sincefeb2022_model_stat <- knitr::kable(sincefeb2022_model_stat, format = 'latex', digits = 2)
writeLines(sincefeb2022_model_stat, 'figures/sincefeb2022_model.tex')
...
test_r2 <- R2(fit.xgb_da$pred$pred, fit.xgb_da$pred$obs)
test_rmse <- RMSE(fit.xgb_da$pred$pred, fit.xgb_da$pred$obs)
```
...
test_r2 <- R2(fit.xgb_da_dis$pred$pred, fit.xgb_da_dis$pred$obs)
test_rmse <- RMSE(fit.xgb_da_dis$pred$pred, fit.xgb_da_dis$pred$obs)
```
...
test_r2 <- R2(fit.xgb_da_excl_dis$pred$pred, fit.xgb_da_excl_dis$pred$obs)
test_rmse <- RMSE(fit.xgb_da_excl_dis$pred$pred, fit.xgb_da_excl_dis$pred$obs)
```
...
xgb_excl_dis_obs_vs_pred_plot_zoom <- ggplot(tibble(obs = fit.xgb_da_excl_dis$pred$obs, 
                                                    pred = fit.xgb_da_excl_dis$pred$pred),
                             aes(x = pred, y = obs)) +
                        geom_point() +
                        geom_abline(intercept = 0, slope = 1, color = 'red') +
...
test_r2 <- R2(fit.xgb_da_full_dis_ind$pred$pred, fit.xgb_da_full_dis_ind$pred$obs)
test_rmse <- RMSE(fit.xgb_da_full_dis_ind$pred$pred, fit.xgb_da_full_dis_ind$pred$obs)
```

```{r}
xgb_full_dis_ind_obs_vs_pred_plot <- ggplot(tibble(obs = fit.xgb_da_full_dis_ind$pred$obs, 
...
xgb_full_dis_ind_obs_vs_pred_plot_zoom <- ggplot(tibble(obs = fit.xgb_da_full_dis_ind$pred$obs, 
                                                        pred = fit.xgb_da_full_dis_ind$pred$pred),
                             aes(x = pred, y = obs)) +
                        geom_point() +
                        geom_abline(intercept = 0, slope = 1, color = 'red') +
...
test_r2 <- R2(fit.xgb_da_full$pred$pred, fit.xgb_da_full$pred$obs)
test_rmse <- RMSE(fit.xgb_da_full$pred$pred, fit.xgb_da_full$pred$obs)
```

```{r}
xgb_everything_obs_vs_pred_plot <- ggplot(tibble(obs = fit.xgb_da_full$pred$obs, 
...
xgb_everything_obs_vs_pred_plot_zoom <- ggplot(tibble(obs = fit.xgb_da_full$pred$obs, 
                                                      pred = fit.xgb_da_full$pred$pred),
                             aes(x = pred, y = obs)) +
                        geom_point() +
                        geom_abline(intercept = 0, slope = 1, color = 'red') +
...
validation_result <- rbind(validation_result,  
                           tibble(Model = 'Everything w.o Disaster Indicator',
                                  'Coef' = summary(lm(fit.xgb_da_full$pred$obs ~
                                                        fit.xgb_da_full$pred$pred))$coefficients[2, 1], 
                                  'R-Sq' = summary(lm(fit.xgb_da_full$pred$obs ~
                                                        fit.xgb_da_full$pred$pred))$r.squared))
```
...
ggarrange(xgb_sincefeb2022_obs_vs_pred_plot, 
          ggarrange(xgb_disaster_obs_vs_pred_plot, xgb_disaster_obs_vs_pred_plot_zoom,  
                    ncol = 2, labels = c("2", "3")),
          ggarrange(xgb_excl_dis_obs_vs_pred_plot, xgb_excl_dis_vs_pred_plot_zoom,  
                    ncol = 2, labels = c("2", "3")),
          ggarrange(xgb_full_dis_ind_obs_vs_pred_plot, xgb_ull_dis_ind_obs_vs_pred_plot_zoom,  
                    ncol = 2, labels = c("2", "3")),
