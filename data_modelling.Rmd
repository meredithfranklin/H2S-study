...
result_10cv <- rbind(result_10cv, tibble(Model = 'Since Feb 2022',
                               ...
                               'Test RMSE' = RMSE(pred_10cv_sincefeb2022, obs_10cv_sincefeb2022)))
...
result_10cv <- rbind(result_10cv, tibble(Model = 'Disaster Only',
                               ...
                               'Test RMSE' = RMSE(pred_10cv_disaster, obs_10cv_disaster)))
...
result_10cv <- rbind(result_10cv, tibble(Model = 'Exclude Disaster',
                               ...
                               'Test RMSE' = RMSE(pred_10cv_excl_disaster, obs_10cv_excl_disaster)))
...
result_10cv <- rbind(result_10cv, tibble(Model = 'Everything w. Disaster Indicator',
                               ...
                               'Test RMSE' = RMSE(pred_10cv_disaster_ind, obs_10cv_disaster_ind)))
...
result_10cv <- rbind(result_10cv, tibble(Model = 'Everything w.o Disaster Indicator',
                               ...
                               'Test RMSE' = RMSE(pred_10cv_everything, obs_10cv_everything)))
...
test_r2 <- R2(test_result_data$pred, test_result_data$obs)
test_rmse <- RMSE(test_result_data$pred, test_result_data$obs)
```
