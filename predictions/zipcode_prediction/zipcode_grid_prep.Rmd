...
zipcode_grid <- st_bbox(patient_zipcode_boundaries_cropped) %>%
                  st_as_stars(dx = 500) %>%
                  st_crop(patient_zipcode_boundaries_cropped)
...
write_csv(zipcode_grid_df[1:1500, ], 'zipcode_grid_df_home.csv')
write_csv(zipcode_grid_df[1501:2909, ], 'zipcode_grid_df_cosmos.csv')
```
