...
# Load in data
```{r}
top_3_blk <- read_csv('top_3_blk_without_metero.csv')
```
...
#                        top_3_blk$INTPTLAT[i], top_3_blk$INTPTLON[i])
#   res = GET(get_url)
#   data = fromJSON(rawToChar(res$content))
#   hourly_result <- rbind(hourly_result, 
#                          tibble(latitude = top_3_blk$INTPTLAT[i],
#                                 longitude = top_3_blk$INTPTLON[i],
...
# }
# 
# write_csv(hourly_result, 'top_3_blk_hourly_with_meteo.csv')
```
