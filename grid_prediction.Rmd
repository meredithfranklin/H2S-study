...
ramp3 <- colorRampPalette(colors = c("yellow", "red"), space = "Lab")(44150)
ramp <- c(ramp1, ramp2, ramp3)

pal <- colorNumeric(palette = ramp, domain = c(0.5, 450), na.color = "transparent")
...
# Combine three palettes for better visual
ramp1 <- colorRampPalette(colors = c("blue", "green"), space = "Lab")(50)
ramp2 <- colorRampPalette(colors = c("green", "yellow"), space = "Lab")(150)
ramp <- c(ramp1, ramp2)
