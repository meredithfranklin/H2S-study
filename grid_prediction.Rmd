...
dis_di_pred <- leaflet() %>% addTiles() %>% 
                  ...
                  addCircleMarkers(data = monitor_loc, 
                         ...
                         fillColor = 'black', weight = 1, stroke = F,
                         label = ~Monitor)

dis_di_pred
saveWidget(dis_di_pred, file="figures/dis_di_pred.html")
writeRaster(raster_di_dis_xgb, file = 'rfiles/raster_di_dis_xgb.tif')
```
...
writeRaster(raster_di_norm_xgb, file = 'rfiles/raster_di_norm_xgb.tif')
```
